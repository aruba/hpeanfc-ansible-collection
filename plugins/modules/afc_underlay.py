...
module: afc_underlay
version_added: "0.0.1"
short_description: Apply an underlay configuration in the specified fabric and vrf.
description: >
    This module applies an underlay configuration in the specified fabric and vrf.
options:
    afc_ip:
        description: >
...
EXAMPLES = r'''
-   name: Create an underlay configuration
...
def main():
    module_args = dict(
        ...
        underlay_name=dict(type="str", required=True),
        underlay_data=dict(type="dict", required=False)
    )
    ...
    underlay_name = ansible_module.params["underlay_name"]
    underlay_data = ansible_module.params["underlay_data"]
    ...
    message, status, changed = vrf_instance.create_underlay(name=underlay_name, **underlay_data)
