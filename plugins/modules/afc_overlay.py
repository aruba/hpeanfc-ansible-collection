...
module: afc_overlay
version_added: "0.0.1"
short_description: Apply an overlay configuration in the specified fabric and vrf.
description: >
    This module applies an overlay configuration in the specified fabric and vrf.
options:
    afc_ip:
        description: >
...
def main():
    module_args = dict(
        ...
        overlay_name=dict(type="str", required=True),
        overlay_data=dict(type="dict", required=False)
    )
    ...
    overlay_name = ansible_module.params["overlay_name"]
    overlay_data = ansible_module.params["overlay_data"]
    ...
    message, status, changed = vrf_instance.create_overlay(name=overlay_name, **overlay_data)
